...
{% hint style="warning" %}
\*\*NOTE: \*\*The return does not contain a list of transactions in the uncle block, to get this, make another request to [eth\_getBlockByHash](eth\_getblockbyhash.md)\_ or \_[eth\_getBlockByNumber](eth\_getblockbynumber.md)
{% endhint %}
