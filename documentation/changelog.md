...
* **\[Network]** Starting **at 9AM PST on July 1st** the Ropsten and Kovan networks will no longer be supported on Alchemy. All requests to those networks after this date will return HTTP 410 errors.&#x20;
